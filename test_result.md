...
agent_communication:
  - agent: "main"
    message: "Успешно реализованы все требования для 2D космического шутера: добавлены звуковые эффекты, меню настроек, уровни сложности, система статистики с графиками и улучшенный дизайн кораблей. Игра готова к тестированию."
  - agent: "testing"
    message: "Проведено тестирование всех ключевых компонентов игры. Создан файл backend_test.py с полным набором тестов для проверки GameSettings, SoundManager, StatisticsManager, GameEngine и игровых объектов. Все тесты успешно пройдены. Также запущен test_game_functions.py, который также подтвердил корректную работу всех компонентов. Все требуемые функции реализованы и работают правильно."